...
export function InvoiceDetailsModal({ isOpen, onClose, invoice, onEdit }: InvoiceDetailsModalProps) {
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              {invoice.customerAddress && (
                <div className="text-sm text-muted-foreground whitespace-pre-line">{invoice.customerAddress}</div>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-12 gap-4 py-2">
                <div className="col-span-10 text-right font-semibold">Total Amount:</div>
                <div className="col-span-2 text-right text-lg font-bold">${invoice.amount.toFixed(2)}</div>
              </div>
            </div>
          </div>
